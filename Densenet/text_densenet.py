...
def save_model(state, filename, model_dir):
    torch.save(state, model_dir + filename)


def train_(model, train_dl, device, nEpoch, checkpoint_name):
    ...
    save_model(state, args.model_dir + checkpoint_name + '.tar')
...
if __name__ == '__main__':
    ...
    train_(net, train_dl, device, args.epochs, checkpoint_name)
